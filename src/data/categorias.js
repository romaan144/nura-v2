// Los nombres humanos de las categorias. Vivian dentro de Home; al
// necesitarlos Comunidad, se extraen en vez de duplicarse: dos copias
// acaban divergiendo (la leccion de obraAPost).
export const CAT_HUMANA = {
