...
console.log('\n── Te aviso si aparece, en tu ciudad ──')
{
  ...
  await llamarG(funcion, { op: 'alta', payload: { name: 'Russafa Ficticia', category: 'canguro', zone: 'Russafa, Valencia' } })
  ok(avisos() === 2, 'no avisa de quien trabaja en «Russafa, Valencia» (la ciudad entre comas cuenta)')
