...
- **Función `helpers-write` versión 22** (2026-09-26), 27 operaciones · avisos por correo automáticos
...
- **Base de datos**: citas en `avisos` (`cita_fecha`, `cita_hora`,
  `cita_estado`, una sola aceptada por hora; `cita_cancela`, `cita_nota` y
  `cita_cambia_de`)
  y `helpers.horario` / `helpers.bloqueos` (migraciones del 2026-10-01 al
  2026-10-10, aplicadas).
...
|---|---|---|
| 0 | Home | ✅ hecha |
| 1 | La respuesta de Nüra | ✅ hecha |
| 2 | La ficha del profesional | ✅ hecha |
| 3 | El chat | ✅ hecha |
| 4 | Profesionales | ✅ hecha |
| 5 | Comunidad | ✅ hecha |
| 6 | Chats y Mis servicios | ✅ hecha |
| 7 | Perfil y Siguiendo | ✅ hecha |
| 8 | Los tres momentos de entrada | ✅ hecha |
...
|---|---|---|
| 1 | Lo roto | ✅ hecha |
| 2 | El profesional edita su ficha (en su móvil) | ✅ hecha |
